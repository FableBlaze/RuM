...
public class TaskSubTaskInfoRight extends Composite {
	...
	public TaskSubTaskInfoRight(TaskSubTaskInfo taskSubTaskInfo, RumController rumController, SubTask subTask) {
		...
		PluginConfigurationComposite pluginConfigurationComposite = new PluginConfigurationComposite(scrolledPluginConfigurationComposite, pluginInfo, rumController, null);
		Gson gson = new Gson();
