...
public class FilesTableViewer extends TableViewer implements RumUpdatableView {
	...
	public FilesTableViewer(TaskGeneralInfo taskGeneralInfo, RumController rumController) {
		super(taskGeneralInfo, SWT.H_SCROLL | SWT.V_SCROLL | SWT.BORDER);
		...
		userFiles = UserFileAccess.getTaskUserFilesDataFromDb(taskGeneralInfo.getTask().getId());
	...
	public void controllerUpdateNotify(ControllerUpdateType updateType, Object updatedEntity) {
		if (updatedEntity instanceof UserFile && ((UserFile)updatedEntity).getTask().getId()==taskGeneralInfo.getTask().getId()) {
