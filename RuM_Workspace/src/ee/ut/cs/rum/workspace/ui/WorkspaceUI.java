...
import ee.ut.cs.rum.workspace.internal.ui.workspace.WorkspaceOverview;
...
public class WorkspaceUI extends Composite {
	...
	public WorkspaceHeader getWorkspacesHeader() {
	...
	public WorkspaceOverview getWorkspacesOverview() {
